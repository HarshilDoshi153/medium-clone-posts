...
const Auth = ({modal, setModal}) => {
    ...
    return (
        <Modal modal={modal} setModal={setModal} hidden={hidden}>
            <section className={`z-50 fixed top-0 bottom-0 left-0 md:left-[10rem] bg-white right-0 md:right-[10rem] flex justify-center py-24 overflow-auto shadows ${hidden} transition-all duration-500`}>
